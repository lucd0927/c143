...
class Guide13SpinWidget extends StatefulWidget {
  const Guide13SpinWidget({
    super.key,
  ...
  @override
  State<Guide13SpinWidget> createState() => _Guide13SpinWidgetState();
}

class _Guide13SpinWidgetState extends State<Guide13SpinWidget> {
  int index = 0;

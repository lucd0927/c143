...
class Guide10_2Quiz2Widget extends StatefulWidget {
  const Guide10_2Quiz2Widget({
    super.key,
  ...
  @override
  State<Guide10_2Quiz2Widget> createState() => _Guide10_2Quiz2WidgetState();
}

class _Guide10_2Quiz2WidgetState extends State<Guide10_2Quiz2Widget> {
  int index = 0;
  double itemHgith = 0;
  ...
  List<List<String>> get texts => [
    ["This question is sponsored ", "by Amazon"],
  ];
...
class Guide10_2BonusWidget extends StatefulWidget {
  const Guide10_2BonusWidget({
    super.key,
    required this.onClose,
    required this.coins,
  });
  ...
  @override
  State<Guide10_2BonusWidget> createState() => _Guide10_2BonusWidgetState();
}

class _Guide10_2BonusWidgetState extends State<Guide10_2BonusWidget> {
  int index = 0;
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    TwTxtGraBorderC143(
                                      text:
                                          "+${TwCountryyC143.curCountryyyySymbolC143()}${widget.coins}",
                                      fontSize: 32.sp,
                                      fontWeight: FontWeight.w900,
                                    ),
                                  ],
